...
class SeedClassSchemasMvpTests(unittest.TestCase):
    ...
    def test_seeds_twenty_classes(self) -> None:
        ...
        try:
            ...
            self.assertEqual(
                ["abstract", "anonymous_fact", "causal_rule", "cognition", "competition", "deferred_task", "entity", "epistemic_state", "event", "learned_fact", "learned_trigger_response", "mood_ambient", "mood_session_summary", "mood_state", "novelty_candidate", "object", "person", "personal_experience", "place", "uol_parse", "user_commitment", "world_fact"],
                ids,
            )
        finally:
            store.close()
