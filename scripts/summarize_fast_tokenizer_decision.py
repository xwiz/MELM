"""Summarize a fast tokenizer probe as a neural-ablation decision."""
...
def main() -> None:
    ...
    parser.add_argument("--report", default="reports/babylm_2026_fast_tokenizer_full.json")
    parser.add_argument("--candidate", default="capped_morpheme")
    parser.add_argument("--out-json", default="reports/babylm_2026_fast_tokenizer_decision.json")
    parser.add_argument("--out-md", default="reports/babylm_2026_fast_tokenizer_decision.md")
