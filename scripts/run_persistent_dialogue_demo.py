"""Run the first persistent event-memory dialogue demo."""
...
def main() -> None:
    ...
    parser.add_argument("--out-json", default="reports/persistent_dialogue_demo.json")
    parser.add_argument("--out-md", default="reports/persistent_dialogue_demo.md")
    ...
    payload = {
        "source": "built_in_authored_child_dialogue",
        "threshold": args.threshold,
        "k": args.k,
        "events": len(events),
    ...
    print("Persistent dialogue demo")
