...
class EnglishAdapter:
    ...
    def correct(self, text: str) -> str:
        ...
        text = self._layer1_symspell(text)
        text = self._layer15_agreement(text)
        return text

    def _layer15_agreement(self, text: str) -> str:
    ...
    def _layer1_symspell(self, text: str) -> str:
        ...
        if not toks:
            return text
        protected = protected_indices(tuple(toks))
        out: list[str] = []
