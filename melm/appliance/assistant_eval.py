    ...
    return (
        ...
        AssistantEvalProfile(
            ...
            cases=(
                ...
                AssistantEvalCase("generic_relativity", "Explain relativity briefly.", "local_answer", "understood_open_domain", expect_allowed=True),
        ...
        AssistantEvalProfile(
            ...
            cases=(
                ...
                AssistantEvalCase("offline_career_goal", "How do I improve my career?", "clarify", "cloud_unavailable", network_available=False),
        ...
        AssistantEvalProfile(
            ...
            cases=(
                ...
                AssistantEvalCase("fun_open_domain", "Tell me something fun about volcanoes.", "local_answer", "understood_open_domain", expect_allowed=True),
        ...
        AssistantEvalProfile(
            ...
            profile=open_domain,
            cases=(
                AssistantEvalCase("airplanes", "How do airplanes fly?", "local_answer", "understood_open_domain", expect_allowed=True),
                AssistantEvalCase("csv_code", "Write Python code to parse a CSV.", "local_answer", "understood_open_domain", expect_allowed=True),
                AssistantEvalCase("capital_history", "Give me a detailed history of ancient Rome.", "local_answer", "understood_open_domain", expect_allowed=True),
