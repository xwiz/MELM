...
- `../MELM_whitepaper.md`: revised validation-first whitepaper.
- `../MELM_validation_implementation_plan.md`: six-month execution plan.
...
- `../reports/morpheme_meaning_mvp.md`: first constructed morpheme/root/meaning inference MVP report.
